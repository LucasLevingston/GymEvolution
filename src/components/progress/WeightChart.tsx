...
export function WeightChart({ data: initialData, onDataChange }: WeightChartProps) {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      await deleteWeight({ id: itemToDelete.id, token });
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this weight entry? This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
