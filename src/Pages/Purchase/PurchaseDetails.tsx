  ...
  switch (status) {
    case 'COMPLETED':
      return {
        ...
        message: 'Pagamento confirmado. Você pode iniciar o atendimento.',
      }
    case 'PENDING':
      return {
        icon: <Info className="h-5 w-5 text-yellow-500 mr-2" />,
...
export default function PurchaseDetails() {
    ...
    const fetchAvailableTimeSlots = async () => {
      ...
      try {
        const response = await fetch(
          `/api/professional/${purchase.professionalId}/availability?date=${selectedDate}`
        )
  ...
  const handleScheduleMeeting = async () => {
    ...
    try {
      ...
      setPurchase((prev) => (prev ? { ...prev, status: 'ACTIVE' } : null))
  ...
  const actionNeeded = getProfessionalActionNeeded(purchase.paymentStatus)
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <PurchaseWorkflowCard purchase={purchase} />
                ...
                <div>
                  ...
                  <div className="flex items-center p-4 bg-muted/50 rounded-lg">
                    <Avatar className="h-12 w-12 mr-4">
                      <AvatarImage
                        src={purchase.professional.imageUrl || '/placeholder.svg'}
                      />
                      <AvatarFallback>
          ...
          <Card>
            ...
            <CardFooter>
              <Button variant="outline" className="w-full" asChild>
                <Link to={`/support/purchases/${purchase.id}`}>
