      ...
      diaDeTreino: [
        {
          ...
          grupo: "Peito",
          exercicios: [
            { nome: "Supino inclinado", repeticoes: 10, quantidadeSeries: 3, variacao: "Drop na Ultima série", feito: false },
            { nome: "Supino reto", repeticoes: 10, quantidadeSeries: 3, feito: false },
            { nome: "Voador", repeticoes: 10, quantidadeSeries: 3, feito: false },
            { nome: "CrossOver", repeticoes: 10, quantidadeSeries: 3, feito: false },
