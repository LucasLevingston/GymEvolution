        ...
        <main className="py-12">
          <section className="mb-16 text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-xl text-muted-foreground">
              Track your progress, analyze your performance, and achieve your fitness
              goals with our comprehensive system.
            </p>
            {!user && (
          ...
          <section className="rounded-lg bg-primary/10 p-8 text-center">
            ...
            <p className="mx-auto mb-6 max-w-2xl text-lg text-muted-foreground">
              Join our community of fitness enthusiasts and take control of your health
              and wellness today.
            </p>
            <Button asChild size="lg">
